...
paramiko_GKG('10.10.10.1', 'ls')
ssh = paramiko.SSHClient()
ssh.set_missing_host_key_policy(paramiko.AutoAddPolicy())
ssh.connect('10.10.10.1', port=22, username='geeksForgeeks',password='geeksForgeeks')
sftp_client = ssh.open_sftp()
sftp_client.put(output_file,'/home/paramiko.txt')
